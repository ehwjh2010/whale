...
// # Tool Exposure
//
// The internal/tools package registers five LSP tools when a manager is
// available: lsp_goto_definition, lsp_find_references, lsp_hover,
// lsp_document_symbol, and lsp_workspace_symbol. Each tool requires an
// "lsp.read" capability and is read-only.
package lsp
...
func (c *LSPConfig) ForExtension(ext string) (*ServerConfig, string, bool) {
	...
	for name, srv := range c.Servers {
		for e := range srv.ExtensionToLanguage {
